...
public class mdl_crearPaquetesPersonalizados {
    ...
    public mdl_crearPaquetesPersonalizados(int i, int j, int k) {
    }

    public mdl_crearPaquetesPersonalizados(int id, int idModo, int idDestino, int idCronograma, int idHotel, int idTransporte, int idUsaurio, int estado, 
